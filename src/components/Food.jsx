...
const Food = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto px-4 py-12">
      <marquee
        direction="right"
        className="text-4xl text-orange-600 text-center font-bold"
      >
        Top Reated Food
      </marquee>
      {/* Filter Row */}
      <div className="flex flex-col lg:flex-row justify-between">
        <div>
          ...
          <div className="flex justify-start flex-wrap">
            <button
              ...
              className="m-1 border-orange-500 hover:bg-orange-400 hover:text-white"
            >
              All
            </button>
            <button
        ...
        {/* Filter Price */}
        <div>
          <h2 className="text-xl font-bold text-gray-700 my-4">Filter Price</h2>
